...
namespace IncosafCMS.Data.Identity
{
    ...
    public class ApplicationUserManager : IApplicationUserManager
    {
        ...
        public virtual async Task<ApplicationIdentityResult> UpdateAsync(AppUser user)
        {
            var applicationUser = user.ToApplicationUser();
            if (applicationUser == null)
            {
            ...
            //var result = _userManager.Update(applicationUser);
            var identityResult = await _userManager.UpdateAsync(applicationUser).ConfigureAwait(false);
