...
namespace IncosafCMS.Data.Extensions
{
    ...
    public static class IdentityExtensions
    {
        ...
        public static ApplicationIdentityUser CopyAppUserProperties(this ApplicationIdentityUser applicationIdentityUser, AppUser appUser)
        {
            ...
            applicationIdentityUser.Department = appUser.Department;
            applicationIdentityUser.DisplayName = appUser.DisplayName;
            applicationIdentityUser.Address = appUser.Address;
            applicationIdentityUser.Position = appUser.Position;
            applicationIdentityUser.MaNV = appUser.MaNV;
            applicationIdentityUser.Tags = appUser.Tags;
            //appUser.SanLuongDK = appUser.SanLuongDK;
        ...
        public static AppUser CopyApplicationIdentityUserProperties(this AppUser appUser, ApplicationIdentityUser applicationIdentityUser)
        {
            ...
            appUser.Department = applicationIdentityUser.Department;
            appUser.DisplayName = applicationIdentityUser.DisplayName;
            appUser.Address = applicationIdentityUser.Address;
            appUser.Position = applicationIdentityUser.Position;
            appUser.MaNV = applicationIdentityUser.MaNV;
            appUser.Tags = applicationIdentityUser.Tags;

            //appUser.SanLuongDK = applicationIdentityUser.SanLuongDK;
        ...
        public static ApplicationRole CopyIdentityRoleProperties(this ApplicationRole applicationRole, ApplicationIdentityRole identityRole)
        {
            ...
            //applicationRole.Permissions = identityRole.Permissions;
            foreach (var userRole in identityRole.Users)
            {
                applicationRole.Users.Add(userRole.ToApplicationUserRole());
            }
            //foreach(var permission in identityRole.Permissions)
            //{
        ...
        public static ApplicationIdentityRole CopyApplicationRoleProperties(this ApplicationIdentityRole identityRole, ApplicationRole applicationRole)
        {
            ...
            //{
            //    identityRole.Permissions.Add(permission);
            //}
            return identityRole;
        }
