...
namespace IncosafCMS.Web.Controllers
{
    ...
    public class UsersAdminController : Controller
    {
        ...
        private IService<AppUser> service;
        IUnitOfWork uow;
        public UsersAdminController(IService<AppUser> _service, IUnitOfWork _uow, IApplicationUserManager userManager, IApplicationRoleManager roleManager)
        {
        ...
        public async Task<ActionResult> Create()
        {
            ...
            ViewData["Departments"] = await uow.Repository<Department>().GetAllAsync();
            ViewData["Positions"] = await uow.Repository<EmployeePosition>().GetAllAsync();
            return View();
        }
        ...
        public async Task<ActionResult> Create(RegisterViewModel userViewModel, params string[] selectedRoles)
        {
            ...
            {
                var user = new AppUser { UserName = userViewModel.UserName, DisplayName = string.IsNullOrEmpty(userViewModel.DisplayName) ? userViewModel.UserName : userViewModel.DisplayName, PhoneNumber = userViewModel.PhoneNumber, Address = userViewModel.Address, Department = userViewModel.department, Position = userViewModel.Position, Email = userViewModel.Email };
        ...
        public async Task<ActionResult> DeleteConfirmed(int? id)
        {
            if (ModelState.IsValid)
            {
                ...
                var appUser = _userManager.FindById(id.Value);
