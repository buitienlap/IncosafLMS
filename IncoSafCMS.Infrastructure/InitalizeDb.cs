...
{
    public class InitalizeDb : DropCreateDatabaseAlways<IncoSafCMSContext>
    {
        protected override void Seed(IncoSafCMSContext context)
        {
            ...
            context.Custommers.Add(custommer1);
            context.Equiments.Add(equiment1);
            context.Accreditations.AddRange(new Accreditation[] { accreditaion1, accreditaion2, accreditaion3 });

            context.Tasks.AddRange(contract1.Tasks);
